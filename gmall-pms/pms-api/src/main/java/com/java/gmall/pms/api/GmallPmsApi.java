...
public interface GmallPmsApi {
    ...
    Resp<List<Category>> querySubCategory(@PathVariable("pid")Long pid);
	...
	Resp<SkuInfo> querySkuBySkuId(@PathVariable("skuId") Long skuId);

	/**
	 * 根据skuId查询sku图片列表
	 */
	 @GetMapping("pms/skuimages/{skuId}")
	 Resp<List<SkuImages>> querySkuImagesBySkuId(@PathVariable("skuId") Long skuId);
	...
	Resp<List<SkuSaleAttrValue>> querySkuSaleAttrValueBySpuId(@PathVariable("spuId") Long spuId);
